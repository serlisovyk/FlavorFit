/*
  ...
  - Added the required column `calories` to the `nutrition_facts` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "nutrition_facts" ADD COLUMN     "calories" DECIMAL(65,30) NOT NULL,
ALTER COLUMN "proteins" SET DATA TYPE DECIMAL(65,30),
