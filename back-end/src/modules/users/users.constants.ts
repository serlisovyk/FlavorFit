...
export const PROFILE_USER_ID_DESCRIPTION = 'ID of the user who owns the profile'
...
export const PROFILE_UPDATE_INPUT_DESCRIPTION = 'Data for updating user profile'
...
export const UPDATE_PROFILE_MUTATION_DESCRIPTION = 'Update current user profile'
...
export const USER_MEASUREMENTS_VALID_ERROR = 'Measurements contain invalid data'
